...
echo "<form method=\"post\" action=\"/cgi-bin/cria_eth1.sh\">"
echo "<H3>Acesso para manuten&ccedil;&atilde;o</H3>"

echo "<p>Informe a quantidade de sub-redes a serem criadas</I></B><input name="qtde_redes" value="1" size="5" maxlength="5">"
