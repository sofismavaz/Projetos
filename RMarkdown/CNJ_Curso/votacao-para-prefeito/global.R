...
tb <- readRDS("/home/lrocio/Projetos/RMarkdown/CNJ_Curso/votacao-para-prefeito/assets/eleicao_prefeito.rds")
str(tb)

br_municipal <- readRDS("/home/lrocio/Projetos/RMarkdown/CNJ_Curso/votacao-para-prefeito/assets/br_municipal.rds")
str(br_municipal)
